...
public class C02_ByName {
    public static void main(String[] args) throws InterruptedException {
        ...
        String actual = usernameBox.getAttribute("value");
...
/**
 * 1. name ler id ler gibi dinamik olamaz
 * 2. ancak birden fazla web elementin name attribute değeri aynı olabilir. Bu durumda
 * name ile locate edersek selenium her zaman ilk web elemente gider ve işlem yapar.
 */