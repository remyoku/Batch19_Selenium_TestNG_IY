...
public class C02_ExcelUtilDemo {
    ...
    public void readExcelFile_2(){
        ...
        //iki boyutlu arreyde belirli bir detayı almak istersem

        System.out.println("dataArrayWithoutFirstRow[1][1] = " + dataArrayWithoutFirstRow[1][1]);

        System.out.println("-----------------------------------------");

        //bütün tabloyu bir maplerden oluşan liste alalım
        ...
        System.out.println("dataList.get(10).get(\"City\") = " + dataList.get(9).get("City"));
