...
public class C01_ExcelDemo {
    ...
    String readFromExcelCell(String path, String sheetName, int row, int column) throws IOException {
        FileInputStream fis = new FileInputStream(path);//bu dosya okuyor
        XSSFWorkbook wb = new XSSFWorkbook(fis);//buda okunan dosyanın excel olduğunu doğruluyıp çalıştırıyor.
        //şuan exceli oluşturdum.
