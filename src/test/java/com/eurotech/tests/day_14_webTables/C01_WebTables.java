...
public class C01_WebTables {
    ...
    public void printWholeTable() {
        ...
        //   driver.get("https://the-internet.herokuapp.com/tables"); nütün testlerde bu url kullanıldığı için before a alındı.
    ...
    @Test
    public void getAllColumHeaders() {
        /**
         * navigate to https://the-internet.herokuapp.com/tables
    ...
    public void getColumnHeadersOneByOne() {
        ...
        System.out.println("columnHeaders.get(1) = " + columnHeaders.get(1).getText());
    ...
    public void getAllCellsInOneRow() {
        ...
        //due
        System.out.println("secondRowCells.get(3).getText() = " + secondRowCells.get(3).getText());
    }
    ...
    public void getSingleCellDataWithRowAndColumn() {
        ...
        for (int i = 1; i <=numberOfRows ; i++) {
            for (int j =1 ; j <=numberOfColumns ; j++) {
                System.out.println(dataOfCell(i, j) + " - ");
            }
            System.out.println();
        }
    }
