...
public class C01_AbsoluteXpath {
    public static void main(String[] args) throws InterruptedException {
        ...
        //burda yaptığımız yazmış olduğumuz yani şuraya şunu gönder diye yukarıda yazdığımız
        // değerin yazıldığını bil ve o yazılı değeri al diyoruz yani kullanıcının yazmış olduğu değeri al
